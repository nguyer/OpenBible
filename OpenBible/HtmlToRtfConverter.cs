...
namespace OpenBible
{
    class HtmlToRtfConverter
    {
        ...
        public static string GetChapterName(DependencyObject obj)
        {
            return (string)obj.GetValue(ChapterName);
        }

        public static void SetChapterName(DependencyObject obj, string value)
        {
            obj.SetValue(ChapterName, value);
        }
        ...
        public static readonly DependencyProperty ChapterName =
            DependencyProperty.RegisterAttached("ChapterName", typeof(string), typeof(HtmlToRtfConverter), new PropertyMetadata("", OnChapterNameChanged));
        ...
        private static void OnChapterNameChanged(DependencyObject sender, DependencyPropertyChangedEventArgs eventArgs) {}
